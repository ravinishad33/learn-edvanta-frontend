    ...
    const fetchCourse = async () => {
      try {
        ...
        reset({
          ...
          video: { url: course.video.url, publicId: course.video.publicId },
        ...
        setVideoPreview(course.video.url);
        setThumbnail({
          url: course.thumbnail.url,
          publicId: course.thumbnail.publicId,
        });
        ...
        setThumbnailPreview(course?.thumbnail?.url || null);
        // setVideoPreview(course?.video?.url || null);
      } catch (error) {
